...
gdjs.evtsExt__BackAndForthMovement__BackAndForthMirroredMovement.BackAndForthMirroredMovement = class BackAndForthMirroredMovement extends gdjs.RuntimeBehavior {
  constructor(instanceContainer, behaviorData, owner) {
    ...
    this._behaviorData = {};
    this._sharedData = gdjs.evtsExt__BackAndForthMovement__BackAndForthMirroredMovement.BackAndForthMirroredMovement.getSharedData(
      instanceContainer,
      behaviorData.name
    );
...
/**
 * Shared data generated from Back and Forth (mirrored) Movement
 */
gdjs.evtsExt__BackAndForthMovement__BackAndForthMirroredMovement.BackAndForthMirroredMovement.SharedData = class BackAndForthMirroredMovementSharedData {
...
gdjs.evtsExt__BackAndForthMovement__BackAndForthMirroredMovement.BackAndForthMirroredMovement.getSharedData = function(instanceContainer, behaviorName) {
  if (!instanceContainer._BackAndForthMovement_BackAndForthMirroredMovementSharedData) {
    const initialData = instanceContainer.getInitialSharedDataForBehavior(
      behaviorName
    );
    instanceContainer._BackAndForthMovement_BackAndForthMirroredMovementSharedData = new gdjs.evtsExt__BackAndForthMovement__BackAndForthMirroredMovement.BackAndForthMirroredMovement.SharedData(
      initialData
    );
  }
  return instanceContainer._BackAndForthMovement_BackAndForthMirroredMovementSharedData;
}
